...
class App extends Component {
  ...
  guardarperfil = () => {
    ...
    //validar que kis campos no esten vacios
    //nombre,apellido,email
    if (!nombre.trim() || !apellido.trim() || !email.trim()) {
      Alert.alert(
        'campos vacios',//titulo de la alert
    ...
    if (!email.includes('@')) {
      Alert.alert(
        'email invalido',//titulo de la alert
    ...
    Alert.alert(
      'Perfil guardado',//titulo de la alert
      'Tu perfil ha sido guardado con exito',
      [{ texto: 'OK' }]
    );  
  };
